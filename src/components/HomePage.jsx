...
function PrevArrowSlider(props) {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div id="content-direction-carousel-service">&#10094;</div>
    </div>
  );
}
...
export default class HomePage extends React.Component {
  constructor(props) {
    ...
    this.onMouseEnterListOurService =
      this.onMouseEnterListOurService.bind(this);
    this.onMouseLeaveListOurService =
      this.onMouseLeaveListOurService.bind(this);
    this.onMouseEnterListArticlesNews =
      this.onMouseEnterListArticlesNews.bind(this);
    this.onMouseLeaveListArticlesNews =
      this.onMouseLeaveListArticlesNews.bind(this);
    this.onMouseEnterListFollowInstagram =
      this.onMouseEnterListFollowInstagram.bind(this);
    this.onMouseLeaveListFollowInstagram =
      this.onMouseLeaveListFollowInstagram.bind(this);
    ...
    this.state = {
      ...
      hoverListArticlesNews: new Array(this.props.cellArticlesNews.length).fill(
        false
      ),
      ratioImageInListArticlesNews: new Array(
        this.props.cellArticlesNews.length
      ).fill(1.0),
  ...
  componentDidMount = () => {
    this.changesizeImageHoverPerson = setInterval(() => {
      ...
      if (this.state.hoverPersonContact)
        this.setState((prevState) => ({
          transXPersonContact: Math.max(
            prevState.transXPersonContact - transPersonContactLength,
            -7
          ),
          transXImageOfPersonContact: Math.min(
            prevState.transXImageOfPersonContact +
              transImageofPersonContactLength,
            10
          ),
        }));
      else
        this.setState((prevState) => ({
          transXPersonContact: Math.min(
            prevState.transXPersonContact + transPersonContactLength,
            0
          ),
          transXImageOfPersonContact: Math.max(
            prevState.transXImageOfPersonContact -
              transImageofPersonContactLength,
            0
          ),
      ...
      if (this.state.hoverPersonScheduling)
        this.setState((prevState) => ({
          transXPersonScheduling: Math.max(
            prevState.transXPersonScheduling - transPersonSchedulingLength,
            -10
          ),
          transXImageOfPersonScheduling: Math.max(
            prevState.transXImageOfPersonScheduling -
              transXImageofPersonSchedulingLength,
            -7
          ),
          transYImageOfPersonScheduling: Math.max(
            prevState.transYImageOfPersonScheduling -
              transYImageofPersonSchedulingLength,
            -4
          ),
        }));
      else
        this.setState((prevState) => ({
          transXPersonScheduling: Math.min(
            prevState.transXPersonScheduling + transPersonSchedulingLength,
            0
          ),
          transXImageOfPersonScheduling: Math.min(
            prevState.transXImageOfPersonScheduling +
              transXImageofPersonSchedulingLength,
            0
          ),
          transYImageOfPersonScheduling: Math.min(
            prevState.transYImageOfPersonScheduling +
              transYImageofPersonSchedulingLength,
            0
          ),
    ...
    this.changesizeListOurService = setInterval(() => {
      ...
      for (let i = 0; i < 4; i++) {
        if (this.state.hoverListOurServices[i])
          ratioImageInListOurService[i] = Math.min(
            ratioImageInListOurService[i] + scaleImageinList,
            1.05
          );
        else
          ratioImageInListOurService[i] = Math.max(
            ratioImageInListOurService[i] - scaleImageinList,
            1.0
          );
      }
    ...
    this.changesizeListArticlesNews = setInterval(() => {
      ...
      for (let i = 0; i < this.props.cellArticlesNews.length; i++) {
        if (this.state.hoverListArticlesNews[i])
          ratioImageInListArticlesNew[i] = Math.min(
            ratioImageInListArticlesNew[i] + scaleImageinList,
            1.05
          );
        else
          ratioImageInListArticlesNew[i] = Math.max(
            ratioImageInListArticlesNew[i] - scaleImageinList,
            1.0
          );
      }
    ...
    this.changesizeListFollowInstagram = setInterval(() => {
      ...
      let rotateZImageInListFollowInstagram =
        this.state.rotateZImageInListFollowInstagrams;
      for (let i = 0; i < 6; i++) {
        if (this.state.hoverListFollowInstagrams[i])
          rotateZImageInListFollowInstagram[i] = Math.min(
            rotateZImageInListFollowInstagram[i] + rotateImageinList,
            3.0
          );
        else
          rotateZImageInListFollowInstagram[i] = Math.max(
            rotateZImageInListFollowInstagram[i] - rotateImageinList,
            0.0
          );
      }
    ...
    return (
      <div>
            ...
            <div id="content-homepage">
              <div id="content-homepage-contact">
                ...
                <div id="slogan-content-homepage-contact">
                  ...
                  Volutpat a feugiat cursus nisi, vel enim. Non et vitae dictum.
                </div>
              ...
              <div id="content-homepage-img-contact">
                <img
                  ...
                  style={{
                    transform:
                      "translate3d(" +
                      this.state.transXPersonContact.toString() +
                      "px, 0px, 0px)",
                  }}
                />
                <img
                  ...
                  style={{
                    transform:
                      "translate3d(" +
                      this.state.transXImageOfPersonContact.toString() +
                      "px, 0px, 0px) rotateZ(" +
                      this.props.rotateZImage.toString() +
                      "deg)",
                  }}
                />
                <img
            ...
            <div id="content-list-contact-info-wrapper">
              <div id="col-contact-info">
                ...
                <div id="content-col-contact-info">
                  <div id="title-content-col-contact-info">Contact us</div>

                  <div id="des-content-col-contact-info">
                    <div id="email-contact-info">contact@vet.com</div>

                    <div id="tel-contact-info">(323) 238 - 0696</div>
                  </div>
                </div>
              </div>
              ...
              <div id="col-contact-info">
                ...
                />
                <div id="content-col-contact-info">
                  <div id="title-content-col-contact-info">Open hours</div>
              ...
              <div id="col-contact-info">
                ...
                />
                <div id="content-col-contact-info">
                  <div id="title-content-col-contact-info">Location</div>
        ...
        <div id="divider-home-page">
          <div id="divider-home-page-wrapper"></div>
        </div>

        <div id="list-service-info">
          <div id="list-service-info-wrapper">
            <div id="title-list-service-info">Our services</div>
                  ...
                  style={
                    this.state.keynotEase === serviceCell.key
                      ? {
                          transform:
                            "translateX(" +
                            this.state.posXListOurServices[index] +
                            ")",
                  ...
                  >
                    <img
                      ...
                      style={{
                        transform:
                          "scale(" +
                          this.state.ratioImageInListOurServices[
                            index
                          ].toString() +
                          ")",
                      }}
                      ...
                      <div
                        ...
                        style={{
                          color:
                            ...
                            String(
                              4100 *
                                this.state.ratioImageInListOurServices[index] -
                                4056
                            ) +
                            ", " +
                            String(
        ...
        <div id="list-brief-about-us-info">
          <div id="list-brief-about-us-info-wrapper">
            ...
            <div id="list-brief-about-us-info-content">
              <div id="brief-about-us-info-content-title">About us</div>

              <div id="brief-about-us-info-content-description">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
                nunc nulla ut lobortis nibh porttitor. Facilisi arcu, nibh vel
                risus, morbi pharetra. Facilisi sit mi sed mauris non iaculis
                elit fusce. Amet nunc in odio molestie lorem mi id a
              </div>
          ...
          <div id="list-client-testimonials-about-us-wrapper">
            <div id="list-client-testimonials-about-us-intro">
              ...
              <div id="list-client-testimonials-about-us-description">
                ...
                ultricies felis feugiat elementum gravida. Facilisis libero
                aliquam curabitur.
              </div>
            </div>
            ...
            <div id="carousel-list-client-testimonials">
              <Slider {...settings}>
                {this.props.cellCustomerTestimonials.map((testimonialsCell) => (
                  <div
                    id="cell-carousel-list-client-testimonials"
                    key={testimonialsCell.key}
                  >
              ...
              <img
                ...
                style={{
                  transform:
                    "rotateZ(" + this.props.rotateZImage.toString() + "deg)",
                }}
              />
            ...
            <div id="schedule-appoint-by-contact-us-image">
              <img
                ...
                style={{
                  transform:
                    "translate3d(" +
                    this.state.transXPersonScheduling.toString() +
                    "px, 0px, 0px)",
                }}
              />
              ...
              <img
                ...
                style={{
                  transform:
                    "translate3d(" +
                    this.state.transXImageOfPersonScheduling.toString() +
                    "px, " +
                    this.state.transYImageOfPersonScheduling.toString() +
                    "px, 0px) rotateZ(" +
                    this.props.rotateZImage.toString() +
                    "deg)",
                }}
                ...
                {this.props.cellArticlesNews.length > 0
                  ? this.props.cellArticlesNews.map((ariticlesNews, index) => (
                      <div
                        ...
                        key={index}
                        onMouseEnter={() =>
                          this.onMouseEnterListArticlesNews(index)
                        }
                        onMouseLeave={() =>
                          this.onMouseLeaveListArticlesNews(index)
                        }
                        onClick={() => {
                          this.props.selectPage("BlogPage");
                        ...
                        <div id="grid-articles-news-info-cell-bg">
                          <img
                            ...
                            style={{
                              transform:
                                "scale3d(" +
                                this.state.ratioImageInListArticlesNews[
                                  index
                                ].toString() +
                                ", " +
                                this.state.ratioImageInListArticlesNews[
            ...
            <div id="grid-list-follow-in-instagram-image">
              {listImageInInstagram.map((listImage, index) => (
                <a
                  ...
                  key={listImage.key}
                  onMouseEnter={() =>
                    this.onMouseEnterListFollowInstagram(index)
                  }
                  onMouseLeave={() =>
                    this.onMouseLeaveListFollowInstagram(index)
                  }
                  style={{
                    transform:
                      "scale3d(" +
                      String(
                        this.state.rotateZImageInListFollowInstagrams[index] /
                          150 +
                          1
                      ) +
                      ", " +
