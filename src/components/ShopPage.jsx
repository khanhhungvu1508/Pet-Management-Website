      ...
      <div id="Stinfo__product">
        ...
        <div id="item--3">
          <div className="row">
            ...
            <div className="col-xl-6">
              <h3>Small and medium dog brush</h3>
              <p
                className="Stinfo__price"
                style={{ fontWeight: "600", fontSize: "24px" }}
              >
        ...
        <div id="item--6">
          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              <h3>Small latex ball pet toy</h3>
              <p
                className="Stinfo__price"
                style={{ fontWeight: "600", fontSize: "24px" }}
              >
