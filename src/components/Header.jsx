...
export default class Header extends React.Component {
  ...
  componentDidMount() {
    ...
    this.changesizeListDetailService = setInterval(() => {
      ...
      let ratioImageInListDetailService =
        this.state.ratioImageInListDetailServices;
      for (let i = 0; i < 4; i++) {
        if (this.state.hoverListDetailServices[i])
          ratioImageInListDetailService[i] = Math.min(
            ratioImageInListDetailService[i] + scaleImageinList,
            1.03
          );
        else
          ratioImageInListDetailService[i] = Math.max(
            ratioImageInListDetailService[i] - scaleImageinList,
            1.0
          );
      }
    ...
    this.changeDirectionIcon = setInterval(() => {
      ...
      if (this.state.dropdownService || this.state.clickDetailServiceMobile)
        this.setState((prevState) => ({
          rotateZIconDirection: Math.min(
            prevState.rotateZIconDirection + rotateImageinList,
            180
          ),
        }));
      else
        this.setState((prevState) => ({
          rotateZIconDirection: Math.max(
            prevState.rotateZIconDirection - rotateImageinList,
            0
          ),
        }));
    ...
    this.changeButtonClick = setInterval(() => {
      ...
      if (this.state.clickButtonMobile) {
        if (transYButtonClicks !== 6.5) {
          ...
          this.setState((prevState) => ({
            rotateZButtonClickFirstBar: Math.min(
              prevState.rotateZButtonClickFirstBar + rotateZTopBar,
              140
            ),
          }));
      } else {
        if (rotateZButtonClickFirstBars !== 0) {
          ...
          this.setState((prevState) => ({
            transYButtonClick: Math.max(
              prevState.transYButtonClick - moveTopBottomBar,
              0
            ),
          }));
      }
      ...
      <div id="header">
        <div id="header-wrapper">
          ...
          >
            ...
            <div id="logo-text">Magic Pet</div>
          </div>
                  ...
                  >
                    <div
                      ...
                      style={
                        ...
                        !this.state.hoverDetailService
                          ? { color: "#f97561" }
                          : { color: "#2c2524" }
                      }
                    >
                      <div id="title-menu">Services</div>
                      ...
                      <div
                        ...
                        style={{
                          transform:
                            "rotateZ(-" +
                            this.state.rotateZIconDirection.toString() +
                            "deg)",
                        }}
                      >
                        <FontAwesome
                    ...
                    {this.state.dropdownService && (
                      <div id="extend-service">
                        <div
                          id="block-content"
                          onMouseEnter={() =>
                            this.onMouseEnter("DetailService")
                          }
                          onMouseLeave={() =>
                            this.onMouseLeave("DetailService")
                          }
                        >
                          <div id="content-extend-service">
                            {this.props.cellContentService.map(
                              (serviceCell, index) => (
                                <div
                                  id="cell-content-service"
                                  key={serviceCell.key}
                                  onMouseEnter={() =>
                                    this.onMouseEnterListOurService(index)
                                  }
                                  onMouseLeave={() =>
                                    this.onMouseLeaveListOurService(index)
                                  }
                                  onClick={() => {
                                      ...
                                      style={{
                                        color:
                                          ...
                                          String(
                                            (20500 *
                                              this.state
                                                .ratioImageInListDetailServices[
                                                index
                                              ]) /
                                              3 -
                                              20368 / 3
                                ...
                                <div id="header-commerce-cart-modal-content-list-detail-info-quality-wrapper">
                                  ...
                                  <div id="header-commerce-cart-modal-content-list-detail-info-quality-btn-wrapper">
                                    <button
                                      ...
                                      type="button"
                                      onClick={() =>
                                        this.props.updateQuantity(index, -1)
                                      }
                                    >
                                      -
                                    </button>
          ...
          <div id="menu-button-contact-detail-mobile">
            ...
            >
              <div id="button-contact-us-wrapper">Contact us</div>
            </div>
                  ...
                  <div id="menu-button-detail-mobile-icon-wrapper">
                    <div
                      ...
                      style={{
                        transform:
                          "translate3d(0px, " +
                          this.state.transYButtonClick.toString() +
                          "px, 0px) rotateZ(" +
                          this.state.rotateZButtonClickFirstBar.toString() +
                          "deg)",
                      }}
                    ></div>
                    <div
                      ...
                      style={{
                        opacity: this.state.opacitySecondBarButtonClick,
                      }}
                    ></div>
                    <div
                      ...
                      style={{
                        transform:
                          ...
                          "px, 0px) rotateZ(" +
                          String(
                            (this.state.rotateZButtonClickFirstBar * 40) / 140
                          ) +
                          "deg)",
                      }}
                    ></div>
