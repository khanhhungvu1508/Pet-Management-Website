          ...
          <div className="row">
            <div className="col col-8">
              ...
              <div className="service-content-bottom">
                ...
                >
                  <div className="service-tabs-menu w-tab-menu" role="tablist">
                    <a
                      data-w-tab="About"
                    ...
                    >
                      <div className="rich-text w-richtext">
                        ...
                        <p>
                          ...
                          rhoncus, sem est molestie. Quam nisi, purus adipiscing
                          dictumst fringilla. Lorem iaculis imperdiet nisi
                          auctor. <strong>Sagittis quis</strong> curabitur morbi
                          tincidunt. Scelerisque nisi, odio. Bibendum fringilla
                        ...
                        <ul >
                          ...
                          <li>
                            ...
                            Sit amet aliquam id diam maer &nbsp;dolore eu fugiat
                            nulla pariatur
                          </li>
                          <li>
