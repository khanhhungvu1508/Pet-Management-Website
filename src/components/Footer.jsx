    ...
    return (
      <div id="footer">
        <div id="footer-wrapper">
          <div id="footer-logo">
            <div id="footer-content">
              <div id="logo-img-text-footer">
                ...
                <div id="logo-text-footer">Magic Pet</div>
              </div>
          ...
          <div id="footer-menu-contact">
            <div id="footer-menu-wrapper">
              <div id="footer-menu-title">Menu</div>
            ...
            <div id="footer-contact-wrapper">
              <div id="footer-contact-wrapper-content">
                <div id="footer-contact-wrapper-content-title">Contact us</div>
        ...
        <div id="footer-copyright-license">
          <div id="footer-copyright">Copyright ©2022 Magic Pet</div>

          <div id="footer-license">
            Designed by&#160; <div id="footer-license-underline">Magic Dev</div>{" "}
            &#160;team
          </div>
        </div>
      </div>
